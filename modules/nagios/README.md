...
!HUOM! Firefox v53.0.2 ei halua näyttää Hosts valikkoa, joka on Current Statuksen alla, mutta Chromella v58.0.3029.110 toimii.

Etusivu

![Nagios etusivu](https://github.com/TommiKurjensalo/keskitettyHallinta/blob/master/img/nagios-etusivu.PNG?raw=true)

Yhteenveto

![Nagios yhteenveto](https://github.com/TommiKurjensalo/keskitettyHallinta/blob/master/img/nagios-summary.PNG?raw=true)
