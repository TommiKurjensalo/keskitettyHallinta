...
Muutettu logiikka niin, että käytetään template tiedostoa, joka sisältää globaalit käyttäjäasetuset. Nämä kopioidaan /etc kansion alle. Käyttäjäkohtaiset asetukset voidaan joko määritellä suoraan moduuliin, [toiseen scriptiin](TommiKurjensalo/keskitettyHallinta/doBase.sh)
